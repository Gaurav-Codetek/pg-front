      ...
      },
      {
        ...
        chapters: [
          ...
          },
          {
            ...
            topics: [
              'Characteristics and its various types',
          ...
          },
          {
            ...
            name: 'Polymorphism',
            topics: [
              'Using function and Operator overloading',
              'Overloading using friend Functions',
              'Type conversions from basic data types to user-defined and vice versa',
            ],
          },
          {
            id: 5,
          ...
          },
          {
            ...
            topics: [
              'Constant pointers',
              'Use of this Pointer',
              'Pointer to derived and base classes',
              'Virtual functions',
              'Bindings',
          ...
          {
            id: 8,
            name: 'Generic Programming With Templates',
            topics: [
              'Definition of class template',
              'Function Templates',
              'Overloading Template Functions',
              'Class templates and member functions templates with parameters',
              'Standard C++ classes',
              'Persistent objects, streams, and files',
              'Namespaces',
              'Exception handling',
              'Generic classes',
              'Standard template library: Library organization and containers',
              'Standard containers',
          ...
          {
            id: 9,
            name: 'Introduction to Object-Oriented Analysis and Design',
            topics: [
